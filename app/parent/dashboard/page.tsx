...
export default function ParentDashboard() {
  ...
  return (
    <div className="animate-fade-in">
      <div className="mb-8">
        <h1 className="font-display font-bold text-3xl text-gray-800">
          Bonjour, {mockParent.name.split(' ')[0]} 👋
        </h1>
      ...
      <div className="flex items-center justify-between mb-5">
        ...
        <Link
          ...
          className="inline-flex items-center gap-1.5 bg-accent text-white text-sm px-4 py-2 rounded-xl font-semibold hover:bg-accent-light transition-colors active:scale-95 duration-100"
        >
