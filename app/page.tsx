    ...
    <div style={{ background: '#0A0A0A', minHeight: '100vh', overflowX: 'hidden' }}>
      ...
      <section style={{ minHeight: '100vh', position: 'relative', display: 'flex', alignItems: 'center', overflow: 'hidden' }}>
        <div style={{ position: 'absolute', inset: 0, zIndex: 0 }}>
          <Image src="/visual3.jpg" alt="hero" fill style={{ objectFit: 'cover', objectPosition: 'center top' }} priority />
          <div style={{ position: 'absolute', inset: 0, background: 'linear-gradient(135deg, rgba(10,10,10,0.9) 40%, rgba(10,10,10,0.6) 100%)' }} />
        </div>
        ...
        <div style={{ position: 'relative', zIndex: 1, maxWidth: '1200px', margin: '0 auto', padding: '8rem 2rem 4rem', width: '100%' }}>
          ...
          <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
            <Link href="/catalogue">
              <button style={{ background: 'linear-gradient(135deg, #008751, #00a862)', color: '#fff', padding: '1rem 2.5rem', borderRadius: '50px', fontFamily: 'Unbounded, sans-serif', fontWeight: 700, fontSize: '0.9rem', boxShadow: '0 8px 40px rgba(0,135,81,0.5)', transition: 'all 0.3s', cursor: 'pointer' }}
                onMouseEnter={e => (e.currentTarget.style.transform = 'translateY(-3px)')}
                onMouseLeave={e => (e.currentTarget.style.transform = 'none')}>
                Découvrir les stylistes →
              </button>
            </Link>
            <Link href="/auth/register">
              <button style={{ background: 'transparent', color: '#fff', padding: '1rem 2.5rem', borderRadius: '50px', fontFamily: 'Unbounded, sans-serif', fontWeight: 700, fontSize: '0.9rem', border: '2px solid rgba(255,255,255,0.3)', transition: 'all 0.3s', cursor: 'pointer' }}
          ...
          <div style={{ display: 'flex', gap: '3rem', marginTop: '4rem', flexWrap: 'wrap' }}>
            {[['200+', 'Stylistes'], ['5000+', 'Tenues'], ['10K+', 'Commandes']].map(([n, l]) => (
              <div key={l}>
                <div style={{ fontFamily: 'Unbounded, sans-serif', fontWeight: 900, fontSize: '2rem', color: '#FCD116' }}>{n}</div>
                <div style={{ color: '#666', fontSize: '0.85rem', fontFamily: 'Montserrat, sans-serif', textTransform: 'uppercase', letterSpacing: '0.1em' }}>{l}</div>
              </div>
            ))}
          </div>
        </div>
        ...
        <div style={{ position: 'absolute', bottom: '2rem', left: '50%', transform: 'translateX(-50%)', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.5rem', opacity: 0.5 }}>
          <div style={{ width: '24px', height: '40px', border: '2px solid #fff', borderRadius: '12px', display: 'flex', justifyContent: 'center', paddingTop: '6px' }}>
            <div style={{ width: '4px', height: '8px', background: '#fff', borderRadius: '2px', animation: 'scroll 2s infinite' }} />
          </div>
        </div>
      ...
      <section style={{ padding: '6rem 2rem', maxWidth: '1200px', margin: '0 auto' }}>
        <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', marginBottom: '3rem', flexWrap: 'wrap', gap: '1rem' }}>
          <div>
            <p style={{ color: '#008751', fontFamily: 'Unbounded, sans-serif', fontSize: '0.75rem', fontWeight: 700, letterSpacing: '0.2em', textTransform: 'uppercase', marginBottom: '0.75rem' }}>NOS CRÉATEURS</p>
            <h2 style={{ fontFamily: 'Unbounded, sans-serif', fontWeight: 900, fontSize: 'clamp(1.6rem, 3vw, 2.5rem)' }}>Stylistes en vedette</h2>
          </div>
          <Link href="/catalogue" style={{ color: '#FCD116', fontFamily: 'Montserrat, sans-serif', fontWeight: 600, fontSize: '0.9rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
      ...
      <section style={{ padding: '5rem 2rem', background: '#080808' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: '3.5rem' }}>
            <p style={{ color: '#FCD116', fontFamily: 'Unbounded, sans-serif', fontSize: '0.75rem', fontWeight: 700, letterSpacing: '0.2em', textTransform: 'uppercase', marginBottom: '0.75rem' }}>COLLECTIONS</p>
      ...
      <section style={{ padding: '6rem 2rem', maxWidth: '1200px', margin: '0 auto' }}>
        <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', marginBottom: '3rem', flexWrap: 'wrap', gap: '1rem' }}>
          <div>
            <p style={{ color: '#E8112D', fontFamily: 'Unbounded, sans-serif', fontSize: '0.75rem', fontWeight: 700, letterSpacing: '0.2em', textTransform: 'uppercase', marginBottom: '0.75rem' }}>🔥 TENDANCES</p>
            <h2 style={{ fontFamily: 'Unbounded, sans-serif', fontWeight: 900, fontSize: 'clamp(1.6rem, 3vw, 2.5rem)' }}>Tenues du moment</h2>
          </div>
          <Link href="/catalogue" style={{ color: '#FCD116', fontFamily: 'Montserrat, sans-serif', fontWeight: 600, fontSize: '0.9rem' }}>
      ...
      <section style={{ background: 'linear-gradient(135deg, #008751 0%, #006b40 100%)', padding: '5rem 2rem', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'absolute', bottom: '-80px', left: '-80px', width: '400px', height: '400px', borderRadius: '50%', background: 'rgba(0,0,0,0.1)' }} />
        <div style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'center', position: 'relative', zIndex: 1 }}>
          <Image src="/logo-icon.jpg" alt="logo" width={80} height={80} style={{ borderRadius: '50%', objectFit: 'cover', margin: '0 auto 1.5rem' }} />
          <h2 style={{ fontFamily: 'Unbounded, sans-serif', fontWeight: 900, fontSize: 'clamp(1.6rem, 3vw, 2.5rem)', marginBottom: '1rem', color: '#fff' }}>
            Vous êtes styliste ?
          </h2>
          ...
          <Link href="/auth/register">
            <button style={{ background: '#FCD116', color: '#0A0A0A', padding: '1rem 2.5rem', borderRadius: '50px', fontFamily: 'Unbounded, sans-serif', fontWeight: 900, fontSize: '0.9rem', cursor: 'pointer', transition: 'all 0.3s', boxShadow: '0 8px 40px rgba(252,209,22,0.4)' }}
      ...
      <section style={{ padding: '6rem 2rem', maxWidth: '1200px', margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
          <p style={{ color: '#FCD116', fontFamily: 'Unbounded, sans-serif', fontSize: '0.75rem', fontWeight: 700, letterSpacing: '0.2em', textTransform: 'uppercase', marginBottom: '0.75rem' }}>L'UNIVERS DAHOMEY</p>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gridTemplateRows: 'auto', gap: '1rem', maxHeight: '600px' }}>
          <div style={{ position: 'relative', borderRadius: '16px', overflow: 'hidden', gridRow: 'span 2' }}>
            <Image src="/visual1.jpg" alt="visual" fill style={{ objectFit: 'cover' }} />
          </div>
          <div style={{ position: 'relative', borderRadius: '16px', overflow: 'hidden', minHeight: '280px' }}>
            <Image src="/visual2.jpg" alt="visual" fill style={{ objectFit: 'cover' }} />
          </div>
          <div style={{ position: 'relative', borderRadius: '16px', overflow: 'hidden', minHeight: '280px' }}>
            <Image src="/visual3.jpg" alt="visual" fill style={{ objectFit: 'cover' }} />
          </div>
        </div>
      </section>
      ...
      <section style={{ padding: '6rem 2rem', background: '#080808' }}>
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: '3.5rem' }}>
            <p style={{ color: '#008751', fontFamily: 'Unbounded, sans-serif', fontSize: '0.75rem', fontWeight: 700, letterSpacing: '0.2em', textTransform: 'uppercase', marginBottom: '0.75rem' }}>FAQ</p>
            ...
            {FAQ.map((item, i) => (
              <div key={i} style={{ background: '#111', border: `1px solid ${openFaq === i ? '#008751' : '#1a1a1a'}`, borderRadius: '12px', overflow: 'hidden', transition: 'border-color 0.3s' }}>
                <button
                  ...
                  style={{ width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '1.25rem 1.5rem', background: 'none', cursor: 'pointer', textAlign: 'left' }}
                >
                  <span style={{ fontFamily: 'Unbounded, sans-serif', fontSize: '0.9rem', fontWeight: 700, color: '#fff', paddingRight: '1rem', lineHeight: 1.4 }}>{item.q}</span>
                  <span style={{ color: '#008751', fontSize: '1.5rem', flexShrink: 0, transition: 'transform 0.3s', transform: openFaq === i ? 'rotate(45deg)' : 'none' }}>+</span>
                </button>
                {openFaq === i && (
