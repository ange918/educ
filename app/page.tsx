...
export default function LandingPage() {
  ...
  return (
    <div className="pb-bottomnav" style={{ background: 'var(--creme)', minHeight: '100vh' }}>
      ...
      <section className="dt-section">
        <div className="dt-container">
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '1.25rem' }}>
            ...
            <Link href="/catalogue" style={{ fontFamily: 'Orbitron, sans-serif', fontSize: '0.82rem', fontWeight: 700, color: 'var(--vert)', display: 'flex', alignItems: 'center', gap: '0.15rem' }}>
          ...
          <div style={{ display: 'flex', gap: '0.6rem', marginBottom: '1.5rem', flexWrap: 'wrap' }}>
            {TABS.map(t => (
              <button key={t.id} onClick={() => setTab(t.id)} style={{
                ...
                fontFamily: 'Orbitron, sans-serif', fontWeight: 700, fontSize: '0.78rem', cursor: 'pointer',
              }}>
                {t.label}
              </button>
            ))}
      ...
      <section className="dt-section" style={{ paddingTop: 0 }}>
        <div className="dt-container">
          <p style={{ fontFamily: 'Orbitron, sans-serif', fontSize: '0.68rem', fontWeight: 700, color: '#C8972A', letterSpacing: '0.12em', textTransform: 'uppercase', marginBottom: '0.4rem' }}>
            Sélection vérifiée
          </p>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '1.25rem' }}>
        ...
        <div className="dt-container">
          <div className="dt-why" style={{ border: '1px solid var(--bordure)' }}>
            ...
            <div style={{ background: 'var(--encre)', padding: '2.5rem 2rem', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
              <p style={{ fontFamily: 'Orbitron, sans-serif', fontSize: '0.68rem', fontWeight: 700, color: 'var(--jaune)', letterSpacing: '0.14em', textTransform: 'uppercase', marginBottom: '0.75rem' }}>
                Pourquoi Dahomey-Tech
              </p>
              <h2 style={{ fontFamily: 'Orbitron, sans-serif', fontWeight: 800, fontSize: 'clamp(1.4rem, 3vw, 2rem)', color: '#fff', lineHeight: 1.2, marginBottom: '1rem' }}>
              ...
              <Link href="/catalogue">
                <button style={{ background: 'var(--jaune)', color: 'var(--encre)', border: 'none', borderRadius: '50px', padding: '0.85rem 1.75rem', fontFamily: 'Orbitron, sans-serif', fontWeight: 800, fontSize: '0.85rem', cursor: 'pointer', display: 'inline-flex', alignItems: 'center', gap: '0.5rem' }}>
      ...
      <section className="dt-section" style={{ paddingTop: 0 }}>
        <div className="dt-container">
          <p style={{ fontFamily: 'Orbitron, sans-serif', fontSize: '0.68rem', fontWeight: 700, color: 'var(--vert)', letterSpacing: '0.14em', textTransform: 'uppercase', marginBottom: '0.5rem' }}>
            Paiement
          </p>
          ...
          <div className="dt-pay">
            {PAIEMENTS.map(p => (
              <div key={p.label} style={{ display: 'flex', alignItems: 'center', gap: '1rem', background: 'var(--blanc)', border: '1px solid var(--bordure)', borderRadius: '14px', padding: '1.1rem 1.25rem' }}>
                ...
                <div>
                  <div style={{ fontFamily: 'Orbitron, sans-serif', fontWeight: 700, fontSize: '0.9rem', color: 'var(--encre)' }}>{p.label}</div>
      ...
      <section className="dt-section" style={{ paddingTop: 0 }}>
        <div className="dt-container">
          <div style={{ background: 'var(--encre)', borderRadius: '22px', padding: '2.5rem 2rem', position: 'relative', overflow: 'hidden', textAlign: 'center' }}>
            ...
            <h2 style={{ fontFamily: 'Orbitron, sans-serif', fontWeight: 800, fontSize: 'clamp(1.3rem, 3vw, 1.9rem)', color: '#fff', margin: '0.8rem auto 0.6rem', lineHeight: 1.25, maxWidth: '560px' }}>
            ...
            <Link href="/auth/register">
              <button style={{ background: 'var(--jaune)', color: 'var(--encre)', border: 'none', borderRadius: '50px', padding: '0.9rem 1.9rem', fontFamily: 'Orbitron, sans-serif', fontWeight: 800, fontSize: '0.88rem', cursor: 'pointer', display: 'inline-flex', alignItems: 'center', gap: '0.5rem' }}>
