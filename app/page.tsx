...
export default function LandingPage() {
  ...
  // Hero entrance animation (runs after loader)
  useEffect(() => {
  ...
  return (
    <div style={{ background: '#0A0A0A', minHeight: '100vh', overflowX: 'hidden' }}>
      ...
      <section style={{ minHeight: '100vh', position: 'relative', display: 'flex', alignItems: 'center', overflow: 'hidden' }}>
        ...
        <div ref={heroRef} style={{ position: 'relative', zIndex: 1, maxWidth: '1200px', margin: '0 auto', padding: '8rem 2rem 4rem', width: '100%' }}>
      ...
      <section style={{ padding: '6rem 2rem', maxWidth: '1200px', margin: '0 auto' }}>
        <div data-gsap="slide-left" style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', marginBottom: '3rem', flexWrap: 'wrap', gap: '1rem' }}>
          <div>
        ...
        <div data-gsap-stagger style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(300px, 1fr))', gap: '1.5rem' }}>
      ...
      <section style={{ padding: '5rem 2rem', background: '#080808' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(170px, 1fr))', gap: '1rem' }}>
            {CATEGORIES_CARDS.map(({ id, label, icon: Icon, color, bg, border }) => (
              <Link href={`/catalogue?categorie=${id}`} key={id}>
                <div data-gsap="scale-in" style={{ background: '#111', border: '1px solid #1a1a1a', borderRadius: '16px', padding: '2rem 1rem', textAlign: 'center', cursor: 'pointer', transition: 'all 0.3s' }}
      ...
      <section style={{ padding: '6rem 2rem', maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div data-gsap-stagger style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(240px, 1fr))', gap: '1.5rem' }}>
      ...
      <section style={{ background: 'linear-gradient(135deg, #008751 0%, #006b40 100%)', padding: '5rem 2rem', position: 'relative', overflow: 'hidden' }}>
        ...
        <div data-gsap="fade-up" style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'center', position: 'relative', zIndex: 1 }}>
      ...
      {/* ── VISUELS ── */}
      <section style={{ padding: '6rem 2rem', maxWidth: '1200px', margin: '0 auto' }}>
        <div data-gsap="fade-up" style={{ textAlign: 'center', marginBottom: '3rem' }}>
        ...
        <div data-gsap-stagger style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gridTemplateRows: 'auto', gap: '1rem', maxHeight: '600px' }}>
