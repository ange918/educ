          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 mt-0.5">
                <span className="text-xs bg-accent-pale text-accent px-2 py-0.5 rounded-full font-medium">
                  {child.classe}
                </span>
        ...
        <div className="flex gap-2 flex-wrap mb-4">
          {child.tranches.map((t) => (
            <div key={t.n} className="flex items-center gap-1">
              {t.paid ? (
                <span className="inline-flex items-center gap-1 bg-accent text-white text-xs px-3 py-1.5 rounded-full font-medium">
