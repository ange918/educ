...
export const mockPayments: Payment[] = [
  { id: 1, childName: 'Kwame Osei', tranche: 'Tranche 2/3', amount: 75000, date: '12 fév 2026', method: 'Mobile Money', status: 'success' },
  { id: 2, childName: 'Kwame Osei', tranche: 'Tranche 1/3', amount: 75000, date: '10 jan 2026', method: 'Mobile Money', status: 'success' },
  { id: 3, childName: 'Ama Osei', tranche: 'Tranche 1/3', amount: 60000, date: '10 jan 2026', method: 'Carte bancaire', status: 'success' },
  { id: 4, childName: 'Kwame Osei', tranche: 'Tranche 3/3', amount: 75000, date: '14 mar 2026', method: 'Mobile Money', status: 'pending' },
  { id: 5, childName: 'Ama Osei', tranche: 'Tranche 2/3', amount: 60000, date: '12 fév 2026', method: 'Mobile Money', status: 'pending' },
  { id: 6, childName: 'Ama Osei', tranche: 'Tranche 3/3', amount: 60000, date: '14 mar 2026', method: 'Carte bancaire', status: 'pending' },
]
...
function makeStudent(
  id: number, firstName: string, lastName: string, classe: string,
  totalFees: number, paid: number, status: 'active' | 'suspended' | 'refused', lastDate: string | null,
): Student {
  return { id, firstName, lastName, classe, numero: `N°${1000 + id}`, totalFees, paid, remaining: totalFees - paid, accessStatus: status, lastPaymentDate: lastDate }
}
